/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=BaseEnv` (hash: e389d75858a646f994b6dc5086a824bb)
// Runtime types generated with workerd@1.20260811.1 2026-08-01 nodejs_compat
interface __BaseEnv_BaseEnv {
	DB: D1Database;
	SIGN_RATE_LIMIT: RateLimit;
	CLOUDFLARE_ENV: "staging" | "production" | "dev";
	TURNSTILE_SECRET_KEY: string;
	LIVE_COUNTER: DurableObjectNamespace<import("./src/server").LiveCounter>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ENV" | "TURNSTILE_SECRET_KEY">> {}
}
