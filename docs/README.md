...
| Decision | Summary |
| -------- | ------- |
| [Database driver](./decisions/database-driver.md) | Cloudflare D1 as the single source of truth — no external database to provision, and signer data stays on the organizer's own account |
