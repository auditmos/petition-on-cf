...
Issues #2, #4, #5, #6, #7 and #8 have landed: D1 persistence, a working sign path, the bilingual content module, the trust pipeline, the live counter, and the voivodeship map.
...
- Remaining issues (#3, #9–#13) define the build order.
