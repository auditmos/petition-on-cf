...
Issues #2 through #9 have landed: D1 persistence, the legal text capture, a working sign path, the bilingual content module, the trust pipeline, the live counter, the voivodeship map, and the full legal layer.
...
- Remaining issues (#10–#13) define the build order.
